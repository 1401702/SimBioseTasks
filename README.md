...
```text
BaseTask.cs       # Definição do objeto de tarefa
Model.cs          # Lógica de dados e serialização
View.cs           # Interface gráfica (Código)
View.Designer.cs  # Interface gráfica (Desenho)
